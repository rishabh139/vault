...
[**CV / Resume**](./link-to-cv.pdf) | [**LinkedIn**](https://linkedin.com/in/rishabh139) | [**GitHub**](https://github.com/yourusername) | [**Email**](mailto:rishabh139@icloud.com)
...
| :--- | :--- |
| **Computational Modeling** | Graph Neural Networks (GAT/GCN), Spectral Parameterization, Dimensionality Reduction |
| **Neuro-Data** | HD-MEA (4k channels), EEG Analysis, Spike Sorting, LFP/MUA Feature Extraction |
| **Industrial AI** | Azure ML Pipelines, Large-Scale ETL, Fraud Detection Systems, LLM Integration |
| **Languages** | Python (PyTorch/TensorFlow), SQL, GAMS, C++ |

---

## Scientific Philosophy

**"Luck is Temporal Optimization."**
